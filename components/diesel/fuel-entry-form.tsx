...
export function FuelEntryForm({
  ...
  const [gallons, setGallons] = useState(
    initialData?.gallons?.toString() ?? ''
  );
  const [pricePerGallon, setPricePerGallon] = useState(
    initialData?.pricePerGallon?.toString() ?? ''
  );
  ...
  const [odometerReading, setOdometerReading] = useState(
    initialData?.odometerReading?.toString() ?? ''
  );
  ...
  const [receiptStorageId, setReceiptStorageId] = useState(
    initialData?.receiptStorageId ?? ''
  );
