...
// ============================================
// NOTIFICATION PREFERENCES PAGE - DRIVER
...
export default function NotificationsScreen() {
  ...
  const [dispatchMessages, setDispatchMessages] = useState(true);
  ...
  const getStatusDescription = () => {
    switch (permissionStatus) {
      case 'granted':
        return t('notifications.permissionGrantedDesc');
      case 'denied':
        return t('notifications.permissionDeniedDesc');
      case 'unavailable':
        return t('notifications.permissionUnavailableDesc');
      default:
        return t('notifications.permissionUndeterminedDesc');
    }
  };
      ...
      >
        ...
        <View style={styles.statusCard}>
          <View style={styles.statusHeader}>
            ...
            <View style={styles.statusInfo}>
              <Text style={styles.statusLabel}>{t('notifications.pushNotifications')}</Text>
              <View style={styles.statusRow}>
                <View style={[styles.statusDot, { backgroundColor: getStatusColor() }]} />
                <Text style={[styles.statusText, { color: getStatusColor() }]}>
                  {isLoading ? t('common.loading') : getStatusText()}
                </Text>
              </View>
            </View>
          </View>
          ...
          {permissionStatus !== 'granted' && permissionStatus !== 'unavailable' && (
            ...
            >
              ...
              <Text style={styles.enableButtonText}>
                {permissionStatus === 'denied' ? t('notifications.openSettings') : t('notifications.enableNotifications')}
              </Text>
            </TouchableOpacity>
          )}
        </View>
            ...
            <View style={styles.card}>
              <View style={styles.settingItem}>
                <View style={styles.settingInfo}>
                  ...
                  <View style={styles.settingText}>
                    <Text style={styles.settingTitle}>{t('notifications.loadAssignments')}</Text>
                    <Text style={styles.settingSubtitle}>{t('notifications.loadAssignmentsDesc')}</Text>
                  </View>
                </View>
                <Switch
                  value={loadAssignments}
                  onValueChange={setLoadAssignments}
              ...
              <View style={styles.settingItem}>
                <View style={styles.settingInfo}>
                  ...
                  <View style={styles.settingText}>
                    <Text style={styles.settingTitle}>{t('notifications.tripUpdates')}</Text>
                    <Text style={styles.settingSubtitle}>{t('notifications.tripUpdatesDesc')}</Text>
                  </View>
                </View>
                <Switch
                  value={tripUpdates}
              ...
              <View style={styles.settingItem}>
                <View style={styles.settingInfo}>
                  <View style={[styles.settingIcon, { backgroundColor: '#FFA50020' }]}>
                    <Ionicons name="chatbubble" size={18} color="#FFA500" />
                  </View>
                  <View style={styles.settingText}>
                    <Text style={styles.settingTitle}>{t('notifications.dispatchMessages')}</Text>
                    <Text style={styles.settingSubtitle}>{t('notifications.dispatchMessagesDesc')}</Text>
                  </View>
                </View>
                <Switch
                  value={dispatchMessages}
                  onValueChange={setDispatchMessages}
                  trackColor={{ false: colors.muted, true: colors.primary }}
                  thumbColor={colors.foreground}
                />
              </View>
              ...
              <View style={styles.settingItem}>
                <View style={styles.settingInfo}>
                  ...
                  <View style={styles.settingText}>
                    <Text style={styles.settingTitle}>{t('notifications.systemAlerts')}</Text>
                    <Text style={styles.settingSubtitle}>{t('notifications.systemAlertsDesc')}</Text>
                  </View>
                </View>
                <Switch
                  value={systemAlerts}
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            {t('notifications.permissionGrantedDesc')}
          </Text>
        </View>
      </ScrollView>
    </View>
